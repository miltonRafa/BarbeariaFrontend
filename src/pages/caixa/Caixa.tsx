  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#121214] border border-[#1f1f23] rounded-lg p-4 sm:p-5">
      ...
      <div className="mt-8">
        <button className="bg-[#c59d5f] hover:bg-[#d6ae70] text-black px-6 py-3 rounded-lg font-bold">
